...
export default function Privacy() {
  return (
    <div className="multipleH2 mx-auto mb-20 mt-10 w-[90%] space-y-10 ">
      <h1 className={`${cormorant.className} text-center text-6xl font-bold`}>
        Privacy Policy
      </h1>
      <div className=" w-[90%] md:ml-10 md:w-[70%] lg:w-1/2 ">
        <div>
        ...
        <div>
          ...
          <p>
            We are dedicated to safeguarding your information and have
        ...
        <div>
          ...
          <p>
            The Culinary Fair is affiliated with third-party advertising
            partners. These partners may collect and use data for advertising
            purposes.
          </p>
          <p>
            You can learn more about their data usage and opt-out options by
            visiting the provided links. We do not share your personal
            information with these third-party advertisers.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p>
            The Culinary Fair may contain links to other websites. However, we
            do not have control over these external sites.
          </p>
          <p>
        ...
        <div>
          ...
          <p>
            We are a member of the affiliate marketing program. This implies
            that we may display customized links given by retailers to track
            referrals to their websites, and we may get an advertising charge
            for any sales made through these connections.
          </p>
        </div>
        <div>
          <h2 className={`${cormorant.className}`}>
          ...
          <p>
            ...
            sell, distribute or lease your personal information to other
            parties.
          </p>
          <p>
            If you have any concerns or requests about your personal
            information, or if you want to withdraw your permission to data
            sharing, please email us at anjabulatovic@icloud.com.
          </p>
          <p>
            We take your privacy seriously and will respond to your requests
            promptly. Please note that certain requests may affect your access
            to specific website features.
          </p>
          <p>
            This Privacy Policy was last updated on 11/06/2023. We reserve the
            right to revise this policy as needed, and any changes will be
            posted on this page.
          </p>
        </div>
      </div>
